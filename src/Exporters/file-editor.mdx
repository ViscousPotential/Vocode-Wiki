...
menu: Exporters
tags: file, editor, obsidian, markdown, notes, transformer
...
| Decoration | `string` | `%s` | This allows you to format text before exporting |
...
Notes will be edited using a similar find and replace to remove the stored text
